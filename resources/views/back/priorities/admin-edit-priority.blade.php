                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-success">
                            <form class="form-horizontal" action="{{ route('admin.priorities.update', $record->id) }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="priority_name" class="col-sm-4 col-form-label">Priority
                                            Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="priority_name"
                                                id="priority_name" value="{{ $record->priority_name }}">
