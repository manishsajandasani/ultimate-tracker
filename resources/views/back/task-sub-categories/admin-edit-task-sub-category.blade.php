    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Task Sub Category</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-6">
                        <div class="card card-success">
                            <form class="form-horizontal"
                                action="{{ route('admin.task.sub.categories.update', $category->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="select2bs4" data-placeholder="Select Task Category"
                                                ...
                                                <option value=""></option>
                                                @foreach ($currentUserCategories as $cat)
                                                    <option value="{{ $cat->id }}"
                                                        {{ $cat->id == $category->task_category_id ? 'selected' : '' }}>
                                                        {{ $cat->task_category_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="task_sub_category_name"
                                                ...
                                                value="{{ $category->task_sub_category_name }}">
                                            <p class="text-danger mt-1 mb-0">
