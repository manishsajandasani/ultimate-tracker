    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Task Assigned By</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-success">
                            <form class="form-horizontal" action="{{ route('admin.task.assigned.by.update', $record->id) }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="task_assigned_by_name" class="col-sm-4 col-form-label">Task Assigned By
                                            Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="task_assigned_by_name"
                                                id="task_assigned_by_name" value="{{ $record->task_assigned_by_name }}">
